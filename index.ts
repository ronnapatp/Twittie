...
async function main() {
  ...
  await client.v1.updateAccountProfile({ name: '@ronnapatp@mastodon.social 🇺🇦', url: 'https://ronnapat.com/', description: `🥳🎄 Merry Christmas & Happy New Year 🎄🎉 | #StandWithUkraine🇺🇦`, location: githubData })
  console.log('Done!')
}
